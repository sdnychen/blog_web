...
const resetForm: ResetForm = reactive({
    email: "",
    emailVerification: "",
    password: "",
    confirmPassword: "",
        ...
        <div class="right">
            <ClientOnly>
                <div class="form-box">
                    ...
                    <n-form ref="resetFormRef" :label-width="80" :model="resetForm" :rules="rules">
                        <n-form-item :show-label="false" :show-feedback="false">
                            <n-grid :cols="2" :x-gap="24">
                                <n-form-item-gi label="邮箱" path="email">
                                    <n-input v-model:value="resetForm.email" placeholder="请输入邮箱" />
                                </n-form-item-gi>
                                <n-form-item-gi label="邮箱验证码" path="emailVerification">
                                    <n-input v-model:value="resetForm.emailVerification" placeholder="请输入邮箱验证码" />
                                </n-form-item-gi>
                            </n-grid>
                        </n-form-item>
                        <n-form-item label="密码" path="password">
                            <n-input v-model:value="resetForm.password" type="password" show-password-on="mousedown"
                                placeholder="请输入密码" />
                        </n-form-item>
                        <n-form-item label="确认密码" path="confirmPassword" :first="true">
                            <n-input v-model:value="resetForm.confirmPassword" type="password"
                                show-password-on="mousedown" placeholder="请确认密码" />
                        </n-form-item>
                        <n-form-item label="验证码" path="verification">
                            <n-input v-model:value="resetForm.verification" placeholder="请输入验证码" />
